...
**Companion Project**: **ScadBundler Live** — a browser (Blazor WebAssembly) UI for drag-and-drop bundling, running the same Core pipeline locally (output is byte-identical to this CLI). **Try it: <https://dano7.github.io/ScadCombiner/>**. Spec/design/slice docs: **[live/](live/)**.
